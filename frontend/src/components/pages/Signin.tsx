...
export default function Signin(){
    ...
    const ButtonInnerHTMl = <div>Sign In</div>;
    ...
    const handleSignIn = () => {
        setButtonContent(<div><SignLoading /></div>);
        axios({
    ...
    return <div className='flex justify-center'>
            <div className='w-[400px] mt-[150px] border-2 border-black rounded-xl'>
                ...
                <div className='mt-[10px] mb-[10px] flex justify-center'><Button buttonContent={buttonContent} onClickEvent={handleSignIn}/></div>
                </div>
    </div>
}